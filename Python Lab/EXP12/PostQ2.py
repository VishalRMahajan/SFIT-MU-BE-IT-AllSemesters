"""Add 3 buttons the GUI window created in i. To display the given input, reset and exit the window."""
...
display_button = ttk.Button(frame, text="Submit/Display", command=display_input)
